...
abstract class Key_Value_Datastore extends Datastore {
	 ...
	 *
	 * @var \MZoo\MBO_Sandbox\Dependencies\Carbon_Fields\Toolset\Key_Toolset
	 */
	...
	public function __construct() {
		$this->key_toolset = \MZoo\MBO_Sandbox\Dependencies\Carbon_Fields\Carbon_Fields::resolve( 'key_toolset' );
		parent::__construct();
	}
