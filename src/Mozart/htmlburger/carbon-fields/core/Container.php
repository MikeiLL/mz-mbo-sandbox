...
class Container {
	 ...
	 *
	 * @see    \MZoo\MBO_Sandbox\Dependencies\Carbon_Fields\Container\Container::factory()
	 * @return \MZoo\MBO_Sandbox\Dependencies\Carbon_Fields\Container\Container
	 */
	public static function factory() {
		return call_user_func_array( array( '\MZoo\MBO_Sandbox\Dependencies\Carbon_Fields\Container\Container', 'factory' ), func_get_args() );
	}
