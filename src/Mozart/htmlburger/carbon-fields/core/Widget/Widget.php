...
namespace MZoo\MBO_Sandbox\Dependencies\Carbon_Fields\Widget;

use MZoo\MBO_Sandbox\Dependencies\Carbon_Fields\Helper\Helper;
use MZoo\MBO_Sandbox\Dependencies\Carbon_Fields\Container\Container;
use MZoo\MBO_Sandbox\Dependencies\Carbon_Fields\Datastore\Datastore;
...
abstract class Widget extends \WP_Widget {
	 ...
	 * Widget Datastore
	 *
	 * @var \MZoo\MBO_Sandbox\Dependencies\Carbon_Fields\Datastore\Widget_Datastore
	 */
	protected $datastore;
	...
	public function setup( $widget_id, $title, $description, $fields, $classname = '' ) {
		\MZoo\MBO_Sandbox\Dependencies\Carbon_Fields\Carbon_Fields::verify_boot();
	...
	public function add_fields( $fields ) {
		foreach ( $fields as $field ) {
			if ( ! ( $field instanceof \MZoo\MBO_Sandbox\Dependencies\Carbon_Fields\Field\Field ) ) {
