...
class Association_Field extends Field {
	 ...
	 *
	 * @var \MZoo\MBO_Sandbox\Dependencies\Carbon_Fields\Toolset\WP_Toolset
	 */
	...
	public function __construct( $type, $name, $label ) {
		$this->wp_toolset = \MZoo\MBO_Sandbox\Dependencies\Carbon_Fields\Carbon_Fields::resolve( 'wp_toolset' );
