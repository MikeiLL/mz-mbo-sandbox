...
class Nav_Menu_Item_Container extends Container {
	...
	public function render() {
		include \MZoo\MBO_Sandbox\Dependencies\Carbon_Fields\DIR . '/templates/Container/nav_menu_item.php';
	}
	...
	public static function edit_walker() {
		return 'MZoo\\MBO_Sandbox\\Dependencies\\Carbon_Fields\\Walker\\Nav_Menu_Item_Edit_Walker';
	}
}
