...
use MZoo\MBO_Sandbox\Dependencies\Carbon_Fields\Container\Condition\Factory;
...
class Array_Translator extends Translator {
	...
	protected function foreign_to_native_fulfillable_collection( $foreign ) {
		...
		$collection = \MZoo\MBO_Sandbox\Dependencies\Carbon_Fields\Carbon_Fields::resolve( 'container_condition_fulfillable_collection' );
